Sub Main()
    ...
    If gitProcess.ExitCode <> 0 Then
        Throw New Exception("Git add fehlgeschlagen: " & gitError.Trim())
    End If
    ...
    gitError = gitProcess.StandardError.ReadToEnd()
    gitProcess.WaitForExit()
    If gitProcess.ExitCode <> 0 AndAlso gitProcess.ExitCode <> 1 Then
        Throw New Exception("Git-Prüfung fehlgeschlagen: " & gitError.Trim())
    End If
    ...
    If gitProcess.ExitCode = 1 Then
        ...
        gitProcess.WaitForExit()
        If gitProcess.ExitCode <> 0 Then
            Throw New Exception("Git commit fehlgeschlagen: " & gitError.Trim())
        End If
        ...
        gitProcess.WaitForExit()
        If gitProcess.ExitCode <> 0 Then
            Throw New Exception("Git pull --rebase fehlgeschlagen: " & gitError.Trim())
        End If
        ...
        gitProcess.WaitForExit()
        If gitProcess.ExitCode <> 0 Then
            Throw New Exception("Git push fehlgeschlagen: " & gitError.Trim())
        End If
    End If
